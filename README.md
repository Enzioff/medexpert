<h1 align="center" style="text-transform: uppercase; font-size: 48px; font-weight: 700">Medexpert лаборатория</h1>
...
<p align="center"><a href="#" target="_blank"><b>Вёрстка проекта</b></a></p>
<hr>
...
<ul>
    ...
    <li>1 - Для перекрытия блока</li>
    <li>2 - Для декоративных элементов</li>
    <li>3 - Элементы которые должны быть выше остальных</li>
    <li>4 - Всплывающие элементы и модальные окна</li>
    <li>5 - Элементы которые всегда поверх всех элементов</li>
</ul>
<hr>
<h3>Методология</h3>
<p>БЭМ</p>
